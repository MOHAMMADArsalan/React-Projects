...
const TestUtils = require("react-addons-test-utils"),
    ...
    Autocompolete = require("./../src/autocomplete.jsx"),
    fD = ReactDOM.findDOMNode;

const autocomplete = TestUtils.renderIntoDocument(
    React.createElement(Autocompolete, {
        options: rooms,
        url: 'test'
    })
)
const optionName = TestUtils.findRenderedDOMComponentWithClass(autoMockOff, 'option-name')

describe('Autocomplete', () => {
    it('have four initial options', () => {
        var options = TestUtils.scryRenderedDOMComponentsWithClass(autocomplete, 'option-listitem')

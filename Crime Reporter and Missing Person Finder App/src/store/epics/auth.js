...
export class AuthEpic {
    ...
    static setLocalStorage(userObj) {
        localStorage.setItem('crimereportingapp', JSON.stringify(userObj));
    }

    static clearLocalStorage() {
        localStorage.removeItem('crimereportingapp');
    }

    static getLocalStorage() {
        return JSON.parse(localStorage.getItem('crimereportingapp'));
    }
}
